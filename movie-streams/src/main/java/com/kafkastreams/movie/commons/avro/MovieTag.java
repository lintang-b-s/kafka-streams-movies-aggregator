...
public class MovieTag extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8299575254265987588L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MovieTag\",\"namespace\":\"com.kafkastreams.movie.commons.avro\",\"fields\":[{\"name\":\"movie_id\",\"type\":\"int\"},{\"name\":\"tag_id\",\"type\":\"int\"},{\"name\":\"created_on\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"last_updated_on\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}}]}");
  ...
  private static final BinaryMessageEncoder<MovieTag> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<MovieTag> DECODER =
   ...
   */
  public static BinaryMessageEncoder<MovieTag> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<MovieTag> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<MovieTag> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this MovieTag to a ByteBuffer.
  ...
  /**
   * Deserializes a MovieTag from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a MovieTag instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static MovieTag fromByteBuffer(
   ...
   */
  public MovieTag(java.lang.Integer movie_id, java.lang.Integer tag_id, java.time.Instant created_on, java.time.Instant last_updated_on) {
   ...
   * @return A new MovieTag RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.MovieTag.Builder newBuilder() {
    return new com.kafkastreams.movie.commons.avro.MovieTag.Builder();
  }
   ...
   * @return A new MovieTag RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.MovieTag.Builder newBuilder(com.kafkastreams.movie.commons.avro.MovieTag.Builder other) {
    if (other == null) {
      return new com.kafkastreams.movie.commons.avro.MovieTag.Builder();
    } else {
      return new com.kafkastreams.movie.commons.avro.MovieTag.Builder(other);
    }
  }
   ...
   * @return A new MovieTag RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.MovieTag.Builder newBuilder(com.kafkastreams.movie.commons.avro.MovieTag other) {
    if (other == null) {
      return new com.kafkastreams.movie.commons.avro.MovieTag.Builder();
    } else {
      return new com.kafkastreams.movie.commons.avro.MovieTag.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MovieTag>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafkastreams.movie.commons.avro.MovieTag.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafkastreams.movie.commons.avro.MovieTag other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.movie_id)) {
        this.movie_id = data().deepCopy(fields()[0].schema(), other.movie_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder setMovieId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder clearMovieId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder setTagId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder clearTagId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder setCreatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder clearCreatedOn() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder setLastUpdatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieTag.Builder clearLastUpdatedOn() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<MovieTag>
    WRITER$ = (org.apache.avro.io.DatumWriter<MovieTag>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<MovieTag>
    READER$ = (org.apache.avro.io.DatumReader<MovieTag>)MODEL$.createDatumReader(SCHEMA$);
