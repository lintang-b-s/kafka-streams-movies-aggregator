...
public class Actor extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1128165137724806035L;
   ...
   */
  public Actor(java.lang.Integer id, java.lang.CharSequence name, java.time.Instant created_on, java.time.Instant last_updated_on) {
    this.id = id;
    this.name = name;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Actor>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Actor.Builder setLastUpdatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Actor.Builder clearLastUpdatedOn() {
