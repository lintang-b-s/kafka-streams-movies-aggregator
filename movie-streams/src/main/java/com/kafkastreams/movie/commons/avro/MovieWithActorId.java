...
public class MovieWithActorId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4252331317531238766L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MovieWithActorId\",\"namespace\":\"com.kafkastreams.movie.commons.avro\",\"fields\":[{\"name\":\"actorId\",\"type\":\"string\"},{\"name\":\"movieId\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"created_on\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"synopsis\",\"type\":\"string\"},{\"name\":\"mpa_rating\",\"type\":\"string\"},{\"name\":\"image\",\"type\":\"string\"},{\"name\":\"r_year\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"notification\",\"type\":\"boolean\"},{\"name\":\"idmb_rating\",\"type\":\"int\"}]}");
  ...
  private static final BinaryMessageEncoder<MovieWithActorId> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<MovieWithActorId> DECODER =
   ...
   */
  public static BinaryMessageEncoder<MovieWithActorId> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<MovieWithActorId> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<MovieWithActorId> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this MovieWithActorId to a ByteBuffer.
  ...
  /**
   * Deserializes a MovieWithActorId from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a MovieWithActorId instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static MovieWithActorId fromByteBuffer(
   ...
   */
  public MovieWithActorId() {}

  /**
   * All-args constructor.
   * @param actorId The new value for actorId
   ...
   */
  public MovieWithActorId(java.lang.CharSequence actorId, java.lang.Integer movieId, java.lang.CharSequence name, java.time.Instant created_on, java.lang.CharSequence type, java.lang.CharSequence synopsis, java.lang.CharSequence mpa_rating, java.lang.CharSequence image, java.time.Instant r_year, java.lang.Boolean notification, java.lang.Integer idmb_rating) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: actorId = (java.lang.CharSequence)value$; break;
   ...
   * @return The value of the 'actorId' field.
   */
  ...
  /**
   * Creates a new MovieWithActorId RecordBuilder.
   * @return A new MovieWithActorId RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder newBuilder() {
    return new com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder();
  }

  /**
   * Creates a new MovieWithActorId RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new MovieWithActorId RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder newBuilder(com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder other) {
    if (other == null) {
      return new com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder();
    } else {
      return new com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder(other);
    }
  }

  /**
   * Creates a new MovieWithActorId RecordBuilder by copying an existing MovieWithActorId instance.
   * @param other The existing instance to copy.
   * @return A new MovieWithActorId RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder newBuilder(com.kafkastreams.movie.commons.avro.MovieWithActorId other) {
    if (other == null) {
      return new com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder();
    } else {
      return new com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder(other);
  ...
  /**
   * RecordBuilder for MovieWithActorId instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MovieWithActorId>
    implements org.apache.avro.data.RecordBuilder<MovieWithActorId> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.actorId)) {
        this.actorId = data().deepCopy(fields()[0].schema(), other.actorId);
    ...
    /**
     * Creates a Builder by copying an existing MovieWithActorId instance
     * @param other The existing instance to copy.
     */
    private Builder(com.kafkastreams.movie.commons.avro.MovieWithActorId other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.actorId)) {
        this.actorId = data().deepCopy(fields()[0].schema(), other.actorId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setActorId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearActorId() {
      actorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setMovieId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearMovieId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setCreatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearCreatedOn() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setSynopsis(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearSynopsis() {
      synopsis = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setMpaRating(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearMpaRating() {
      mpa_rating = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setImage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearImage() {
      image = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setRYear(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearRYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setNotification(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearNotification() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder setIdmbRating(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.MovieWithActorId.Builder clearIdmbRating() {
    ...
    public MovieWithActorId build() {
      try {
        MovieWithActorId record = new MovieWithActorId();
        record.actorId = fieldSetFlags()[0] ? this.actorId : (java.lang.CharSequence) defaultValue(fields()[0]);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<MovieWithActorId>
    WRITER$ = (org.apache.avro.io.DatumWriter<MovieWithActorId>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<MovieWithActorId>
    READER$ = (org.apache.avro.io.DatumReader<MovieWithActorId>)MODEL$.createDatumReader(SCHEMA$);
