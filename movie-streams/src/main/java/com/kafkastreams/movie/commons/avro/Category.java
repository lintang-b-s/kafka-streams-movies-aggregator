...
public class Category extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4087583402678741178L;
   ...
   */
  public Category(java.lang.Integer id, java.lang.CharSequence name, java.time.Instant created_on) {
    this.id = id;
    this.name = name;
