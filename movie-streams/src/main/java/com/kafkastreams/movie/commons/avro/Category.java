...
public class Category extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 735667713004040029L;
   ...
   */
  public Category(java.lang.Integer id, java.lang.CharSequence name, java.time.Instant created_on, java.time.Instant last_updated_on) {
    this.id = id;
    this.name = name;
   ...
   */
  public static com.kafkastreams.movie.commons.avro.Category.Builder newBuilder() {
    return new com.kafkastreams.movie.commons.avro.Category.Builder();
  }
   ...
   * @return A new Category RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.Category.Builder newBuilder(com.kafkastreams.movie.commons.avro.Category.Builder other) {
    if (other == null) {
      return new com.kafkastreams.movie.commons.avro.Category.Builder();
    } else {
      return new com.kafkastreams.movie.commons.avro.Category.Builder(other);
    }
  }
   ...
   * @return A new Category RecordBuilder
   */
  public static com.kafkastreams.movie.commons.avro.Category.Builder newBuilder(com.kafkastreams.movie.commons.avro.Category other) {
    if (other == null) {
      return new com.kafkastreams.movie.commons.avro.Category.Builder();
    } else {
      return new com.kafkastreams.movie.commons.avro.Category.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Category>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafkastreams.movie.commons.avro.Category.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafkastreams.movie.commons.avro.Category other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder setCreatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder clearCreatedOn() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder setLastUpdatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafkastreams.movie.commons.avro.Category.Builder clearLastUpdatedOn() {
